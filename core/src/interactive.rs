...
impl BroadcastMessage {
    pub fn to_string<'a>(
        ...
        Ok(match self.variant {
            ...
            FriendSelectionPolicySet { policy: FriendSelectionPolicy::Unrestricted} => "Friend can be selected by any card".to_string(),
            FriendSelectionPolicySet { policy: FriendSelectionPolicy::HighestCardNotAllowed} => "Friend can not be selected by highest card".to_string(),
